...
const cities = {
  // @blue GÓRY
  "GÓRY": {
    "Tatry" : {coor: [49.1792488,20.0884581], zoom: 12, gallery: [
    ...
    "Pieniny" : {coor: [49.4138194, 20.4141855], zoom: 12, gallery: [
  ...
  // @blue Dolnośląskie
  "Dolnośląskie": {
    "WROCŁAW" : {abbr: "DW", coor: [51.1097396,17.0308739], zoom: 12, date: [2020]},
    "GŁOGÓW" : "DGL",
    "JELENIA GÓRA" : {abbr: "DJ", coor: [50.9030531,15.7340312], zoom: 14, date: [2022]},
  ...
  // @blue Małopolskie
  "Małopolskie": {
    "KRAKÓW" : {abbr: "KR", coor: [50.0616779, 19.9373317], zoom: 12, date: [2023], gallery: [
      ...
      {coor: [50.0661218, 19.9423380], catg: cat.gastro, name: 'Glonojad', date: [2015]},
      {coor: [50.0600244, 19.9375925], catg: cat.gastro, name: 'Gruzińskie Chaczapuri', date: [2015]},
      {coor: [50.0663060, 19.9425030], catg: cat.gastro, name: 'Jagienka', date: [2015]},
      {coor: [50.0665471, 19.9426585], catg: cat.gastro, name: 'Jarema', date: [2014]},
      {coor: [50.0641401, 19.9315488], catg: cat.gastro, name: 'Mamma Mia', date: [2014]},
      {coor: [50.0573721, 19.9302050], catg: cat.gastro, name: 'Musso sushi', date: [2013]},
      ...
      {coor: [50.0651955, 19.9384703], catg: cat.gastro, name: 'Zapiecek', date: [2015]},
    ]},
    "Alwernia" : "KCHA",
    "Andrychów" : "KWAA",
    "Biecz" : "KGRB",
    ...
    "Gorlice" : "KGR",
    "Grybów" : "KNSG",
    "Jordanów": {abbr: "KSUJ", coor: [49.6494070,19.8296517], zoom: 15, date: [2020]},
    ...
    "Myślenice" : {abbr: "KMY", coor: [49.8347232,19.9387157], zoom: 14, gallery: [
      ...
      {coor: [49.8287336,19.9405289], catg: cat.religion, name: 'Kościółek św. Jakuba - zewnętrze'},
