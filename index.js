...
const cities = {
  ...
  "Małopolskie": {
    ...
    "KRAKÓW" : 
      ...
      {coor: [50.0647909, 20.0533479], catg: cat.religion, name: 'Bazylika MB Wniebowziętej (Cystersów) [Mogiła]/Zewnętrze'}, 
      {coor: [50.0647909, 20.0533479], catg: cat.religion, name: 'Bazylika MB Wniebowziętej (Cystersów) [Mogiła]/Wnętrze'}, 
      {coor: [50.0647909, 20.0533479], catg: cat.religion, name: 'Bazylika MB Wniebowziętej (Cystersów) [Mogiła]/Ołtarz'}, 
      ...
      {coor: [50.0656707, 20.0517601], catg: cat.religion, name: 'Kościół św. Bartłomieja (Cystersów) [Mogiła]/Zewnętrze'},
      ...
      {coor: [50.0809470, 20.0560302], catg: cat.religion, name: 'Kościół św. Jana Chrzciciela [Krzesławice]/Zewnętrze'},
      ...
      {coor: [50.0681947, 19.9414301], catg: cat.religion, name: 'Kościół św. Wincentego a Paulo (Misjonarzy) [Kleparz]/Zewnętrze'},
      {coor: [50.0681947, 19.9414301], catg: cat.religion, name: 'Kościół św. Wincentego a Paulo (Misjonarzy) [Kleparz]/Wnętrze'},
      {coor: [50.0681947, 19.9414301], catg: cat.religion, name: 'Kościół św. Wincentego a Paulo (Misjonarzy) [Kleparz]/Ołtarz'},
      {coor: [50.0608927, 19.9377394], catg: cat.religion, name: 'Kościół św. Wojciecha [Stare Miasto]/Zewnętrze'},
      {coor: [50.0608927, 19.9377394], catg: cat.religion, name: 'Kościół św. Wojciecha [Stare Miasto]/Wnętrze'},
      {coor: [50.0608927, 19.9377394], catg: cat.religion, name: 'Kościół św. Wojciecha [Stare Miasto]/Organy'},
      ...
      {coor: [50.0583287, 19.9249023], catg: cat.culture, name: 'Kino Kijów'},
      {coor: [50.0615969, 19.9352033], catg: cat.culture, name: 'Kino pod Baranami'},
      ...
      {coor: [50.0604312, 19.9236229], catg: cat.culture, name: 'Muzeum Narodowe'},
      {coor: [50.0659255, 19.9561957], catg: cat.culture, name: 'Opera Krakowska', date: [2013, 2021]},
      {coor: [50.0579722, 19.9204123], catg: cat.culture, name: 'Stadion Cracovia'},
      ...
      {coor: [50.0631621, 19.9353603], catg: cat.culture, name: 'Teatr Stary'},
      {coor: [50.0563845, 19.9264419], catg: cat.culture, name: 'Teatr Stu'},
      {coor: [50.0568383, 19.9639110], catg: cat.culture, name: 'Teatr Variete', date: [2022]},   

      // Natura
      {coor: [50.0592327, 19.9206054], catg: cat.nature, name: 'Błonia'},
      ...
      {coor: [50.0553960, 20.0580633], catg: cat.nature, name: 'Lasek Mogilski'},
      ...
      {coor: [50.0653109, 19.9290866], catg: cat.nature, name: 'Park Szymborskiej'},
      ...
      {coor: [50.0595737, 19.9411619], catg: cat.nature, name: 'Planty'},
